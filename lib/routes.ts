...
export const routes = {
  ...
  public: {
    ...
    hvacTimeTracking: "/hvac-time-tracking",
    hvacSchedulingSoftware: "/hvac-scheduling-software",
    hvacPayrollSoftware: "/hvac-payroll-software",
    dispatchSoftware: "/dispatch-software",
    login: "/login",
    signup: "/signup",
  },
