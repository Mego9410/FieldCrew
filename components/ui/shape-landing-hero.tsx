    ...
    >
      <div
        className={cn(
          ...
          "shadow-[0_8px_32px_0_rgba(249,115,22,0.08)]",
  ...
  if (reduceMotion) {
    return (
      <div
        ...
        style={{ opacity: 0.85, transform: `rotate(${rotate}deg)` }}
      >
        {pill}
      </div>
    );
...
/** Floating geometric pills for use behind landing hero content (FieldCrew palette). */
export function ShapeLandingHeroBackground({
  className,
  reduceMotion = false,
}: {
  className?: string;
  ...
  return (
    <div
      ...
      aria-hidden
    >
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/[0.07] via-transparent to-amber-600/[0.06] blur-3xl" />
...
function HeroGeometric({
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#030303]">
      <ShapeLandingHeroBackground className="opacity-90" />
